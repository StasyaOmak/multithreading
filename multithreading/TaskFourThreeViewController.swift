//
//  TaskFourThreeViewController.swift
//  multithreading
//
...
/*
 N°3 Давайте теперь используя прошлую rmOperation еще и свою OperationQueue напишем для понимания.
 Теперь используйте в таком же примере Operation и OperationQueue от swift и сравните.
 */

import UIKit

class TaskFourThreeViewController: UIViewController {
